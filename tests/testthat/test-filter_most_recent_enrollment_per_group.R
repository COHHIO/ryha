test_that("filter_most_recent_enrollment_per_group keeps the enrollment without exit date", {
  ...
  kept_enrollment <- filter_most_recent_enrollment_per_group(mock_data, grouping_vars = c("organization_id", "personal_id")) |> 
