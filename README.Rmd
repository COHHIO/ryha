...
Once the container is running, you can set the environmental variable `CREATE_DM_ENV` to `dev` in `.Renviron` to run the application connected to the development database.
