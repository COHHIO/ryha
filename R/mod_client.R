  ...
  tagList(
    ...
    shiny::fluidRow(
      echarts4r::echarts4rOutput(
        outputId = ns("chart_gender"),
        width = "50%",
        height = 350
      ),
      echarts4r::echarts4rOutput(
        outputId = ns("chart_ethnicity"),
        width = "50%",
        height = 350
      )
    ),
    ...
    shiny::fluidRow(
      echarts4r::echarts4rOutput(
        outputId = ns("chart_age"),
        width = "50%",
        height = 350
      ),
      echarts4r::echarts4rOutput(
        outputId = ns("chart_veteran"),
        width = "50%",
        height = 350
      )
    )
  ...
  moduleServer( id, function(input, output, session){
    ...
    output$chart_gender <- echarts4r::renderEcharts4r({
      ...
      filtered_dm()$gender |>
        ...
        echarts4r::e_bar(n, legend = FALSE, name = "# of Clients") |>
